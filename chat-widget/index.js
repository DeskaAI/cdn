(function () {
  ...
  var EA = function (e) {
    ...
    kj = Q.d.createContext({ __EMOTION_VERSION__: DA.version, theme: null }),
    lj = function () {
  ...
  var jB = function (e) {
    ...
    cq = function (e) {
      var $ = e.components,
        r = e.children,
        n = oj();
      return ta(cB, { components: jB(Object.assign({}, n, $)), children: r });
    };
  ...
  var _f = { space: [0, 4, 8, 16, 32, 64, 128, 256, 512] },
    GB = {
      ...
      bottom: { property: 'bottom', scale: 'space', defaultScale: _f.space },
  ...
  var EC = function () {
    ...
    Aj = function (t) {
      ...
      return Q.d.createElement(
        ...
        Q.d.createElement(FC, { customIconUrl: o, iconVariant: $, isOpen: e })
      );
    };
      ...
      return (
        (r.prototype.debug = function () {
          ...
          this.debugModeEnabled &&
            console.debug.apply(console, we(['[deska]'], r));
        }),
        (r.prototype.log = function () {
          for (var r = [], o = 0; o < arguments.length; o++)
            r[o] = arguments[o];
          this.debugModeEnabled &&
            console.log.apply(console, we(['[deska]'], r));
        }),
        (r.prototype.info = function () {
          for (var r = [], o = 0; o < arguments.length; o++)
            r[o] = arguments[o];
          console.info.apply(console, we(['[deska]'], r));
        }),
        (r.prototype.warn = function () {
          for (var r = [], o = 0; o < arguments.length; o++)
            r[o] = arguments[o];
          console.warn.apply(console, we(['[deska]'], r));
        }),
        (r.prototype.error = function () {
          for (var r = [], o = 0; o < arguments.length; o++)
            r[o] = arguments[o];
          console.error.apply(console, we(['[deska]'], r));
        }),
        r
      );
    })();
  ...
  var wD =
    ...
    xD = 'https://chat-window.deskaai.com',
    yD = function (e, t) {
      var n = function (e) {
        t(e);
      };
      ...
      function t(t) {
        ...
        (n.subscriptions = []),
          ...
          (n.updateCustomerMetadata = function (e, t) {
            ...
            return n.send('customer:update', { customerId: e, metadata: a });
          }),
        ...
        if (!pD(r))
          throw (
            (console.error(
              ...
              console.error(
                "If you're missing a deska `token`, you can get one by signing up for a free account at https://app.deskaai.com/signup"
              ),
    ...
    Yq = (function (t) {
      ...
      return (
        ...
        (r.prototype.componentDidCatch = function (t, r) {
          console.error('Error rendering deska chat:', t, r);
        }),
        (r.prototype.render = function () {
  ...
  if (!iE)
    throw new Error(
      'An account token is required to render the Deska chat widget!'
    );
  var sr = document.createElement('div');
  var jE = za(qs);
  (sr.id = 'DeskaChatWidget'),
    ...
    jE.d.render(
      ...
      document.getElementById('DeskaChatWidget')
    );
})();
